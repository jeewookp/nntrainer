...
LOCAL_MODULE := unittest_kai_q40_comparison_test
LOCAL_CFLAGS := -Igoogletest/include -I../include -pthread -fexceptions -fopenmp -static-openmp -DMIN_CPP_VERSION=201703L -DNNTR_NUM_THREADS=1 -D__LOGGING__=1 -DENABLE_TEST=1 -DREDUCE_TOLERANCE=1 $(ARM_MARCH_FLAGS) -O3 -frtti -DNDK_BUILD=1 -DENABLE_FP16=1 -DUSE__FP16=1 -DENABLE_OPENCL=1 
ifeq ($(NDK_DEBUG),1)
LOCAL_CFLAGS += -DDEBUG
endif
LOCAL_CXXFLAGS      += -std=c++17 -frtti -fexceptions
...
LOCAL_SRC_FILES := \
    ../unittest/unittest_kai_q40_comparison_test.cpp
