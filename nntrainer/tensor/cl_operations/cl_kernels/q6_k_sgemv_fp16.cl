// fp16 input/output variant of kernel_mul_mv_q6_K_f32.
// Same Q6_K dequant + accumulate algorithm; activation and logits
// stay fp16 so the lm_head can call this directly without
// fp16<->fp32 conversion stages on either side. Internal accumulation
// stays fp32 for numerical headroom.
