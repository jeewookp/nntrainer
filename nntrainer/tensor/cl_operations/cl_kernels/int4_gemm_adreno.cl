...
// Full FP32 GEMM: input is FP32 image, scale is FP32, output is FP32
...
gpu_int4_gemm_adreno(
    ...
    for(int k=0; k<K; k+=4){
        ...
        // Weight via texture cache (image1d_buffer, half-format -> reinterpret as ushort)
        ...
        dq_weights_reg.s0 = ((float)(packed_w.s0 & (0x000F))-8.0f) * scale.s0;
        dq_weights_reg.s1 = ((float)(packed_w.s1 & (0x000F))-8.0f) * scale.s1;
        dq_weights_reg.s2 = ((float)(packed_w.s2 & (0x000F))-8.0f) * scale.s2;
        dq_weights_reg.s3 = ((float)(packed_w.s3 & (0x000F))-8.0f) * scale.s3;
        ...
        dq_weights_reg.s0 = ((float)((packed_w.s0 & (0x00F0)) >> 4) - 8.0f) * scale.s0;
        dq_weights_reg.s1 = ((float)((packed_w.s1 & (0x00F0)) >> 4) - 8.0f) * scale.s1;
        dq_weights_reg.s2 = ((float)((packed_w.s2 & (0x00F0)) >> 4) - 8.0f) * scale.s2;
        dq_weights_reg.s3 = ((float)((packed_w.s3 & (0x00F0)) >> 4) - 8.0f) * scale.s3;
        ...
        dq_weights_reg.s0 = ((float)((packed_w.s0 & (0x0F00)) >> 8) - 8.0f) * scale.s0;
        dq_weights_reg.s1 = ((float)((packed_w.s1 & (0x0F00)) >> 8) - 8.0f) * scale.s1;
        dq_weights_reg.s2 = ((float)((packed_w.s2 & (0x0F00)) >> 8) - 8.0f) * scale.s2;
        dq_weights_reg.s3 = ((float)((packed_w.s3 & (0x0F00)) >> 8) - 8.0f) * scale.s3;
        ...
        dq_weights_reg.s0 = ((float)((packed_w.s0 & (0xF000)) >> 12) - 8.0f) * scale.s0;
        dq_weights_reg.s1 = ((float)((packed_w.s1 & (0xF000)) >> 12) - 8.0f) * scale.s1;
        dq_weights_reg.s2 = ((float)((packed_w.s2 & (0xF000)) >> 12) - 8.0f) * scale.s2;
        dq_weights_reg.s3 = ((float)((packed_w.s3 & (0xF000)) >> 12) - 8.0f) * scale.s3;
